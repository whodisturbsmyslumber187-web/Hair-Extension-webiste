        ...
        <ContentSection title="Our Sourcing Standards">
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div className="space-y-6">
              <h3 className="text-xl font-medium text-foreground">Ethically Sourced</h3>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-medium text-foreground">Cuticle-Aligned</h3>
              <p className="text-foreground/80 font-normal leading-relaxed">
          ...
          <div className="bg-muted/10 p-8">
            <h3 className="text-2xl font-medium text-foreground mb-6">Quality Benchmarks</h3>
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                <div className="text-3xl font-medium text-primary mb-2">100%</div>
                <p className="text-sm font-normal text-foreground/70">Virgin human hair — no synthetics, no blends</p>
              </div>
              <div>
                <div className="text-3xl font-medium text-primary mb-2">Grade 12A</div>
                <p className="text-sm font-normal text-foreground/70">Highest quality grade available on the market</p>
              </div>
              <div>
                <div className="text-3xl font-medium text-primary mb-2">12–24 mo</div>
                <p className="text-sm font-normal text-foreground/70">Lifespan with proper care and maintenance</p>
              </div>
            </div>
          </div>
        </ContentSection>
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-foreground">Texture Verification</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-foreground">Weight & Length Accuracy</h3>
                <p className="text-foreground/80 font-normal">
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4 bg-muted/10 p-6">
                <h4 className="font-medium text-foreground">Washing</h4>
                <ul className="space-y-2 text-sm font-normal text-foreground/70">
              ...
              <div className="space-y-4 bg-muted/10 p-6">
                <h4 className="font-medium text-foreground">Styling & Maintenance</h4>
                <ul className="space-y-2 text-sm font-normal text-foreground/70">
