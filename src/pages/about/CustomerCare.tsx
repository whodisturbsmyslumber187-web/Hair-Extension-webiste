        ...
        <ContentSection title="Get in Touch">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-foreground drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">WhatsApp</h3>
              <p className="text-foreground font-semibold drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">+1 (555) 123-4567</p>
              <p className="text-sm text-foreground font-semibold drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">Fastest response — message us anytime</p>
            </div>
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-foreground drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">Email</h3>
              <p className="text-foreground font-semibold drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">care@nayahair.com</p>
              <p className="text-sm text-foreground font-semibold drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">Response within 24 hours</p>
            </div>
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-foreground drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">Instagram DM</h3>
              <p className="text-foreground font-semibold drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">@nayahair</p>
              <p className="text-sm text-foreground font-semibold drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">Send us a DM for quick questions</p>
            </div>
          </div>
        </ContentSection>
        ...
        <ContentSection title="Frequently Asked Questions">
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="hair-type" className="border border-border px-6">
              <AccordionTrigger className="text-left hover:no-underline font-bold drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">
                What type of hair do you sell?
              </AccordionTrigger>
              <AccordionContent className="text-foreground font-semibold drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-foreground drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">First Name</label>
                  <Input className="rounded-none" placeholder="Your first name" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-foreground drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">Last Name</label>
                  <Input className="rounded-none" placeholder="Your last name" />
                </div>
              </div>
              
              <div className="space-y-2">
                <label className="text-sm font-bold text-foreground drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">Email</label>
                <Input type="email" className="rounded-none" placeholder="Your email address" />
              </div>
              
              <div className="space-y-2">
                <label className="text-sm font-bold text-foreground drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">Order Number (Optional)</label>
                <Input className="rounded-none" placeholder="e.g. NAYA-12345" />
              </div>
              
              <div className="space-y-2">
                <label className="text-sm font-bold text-foreground drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">How can we help?</label>
                <Textarea 
