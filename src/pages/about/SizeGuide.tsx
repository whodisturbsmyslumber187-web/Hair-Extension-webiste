        ...
        <ContentSection title="Bundle Lengths">
          <div className="space-y-8">
            <div className="bg-muted/10 p-8">
              <h3 className="text-xl font-light text-foreground mb-6">How to Choose Your Length</h3>
            ...
            <table className="w-full border-collapse border border-border">
              <thead>
                <tr className="bg-muted/20">
                  <th className="border border-border p-3 text-left font-light">Length</th>
                  <th className="border border-border p-3 text-left font-light">Bundles Needed</th>
                  <th className="border border-border p-3 text-left font-light">Best For</th>
                  <th className="border border-border p-3 text-left font-light">Closure/Frontal</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={index} className="hover:bg-muted/10">
                    <td className="border border-border p-3 text-foreground">{row.length}</td>
                    <td className="border border-border p-3 text-foreground">{row.bundles}</td>
                    <td className="border border-border p-3 text-muted-foreground">{row.best}</td>
                    <td className="border border-border p-3 text-muted-foreground">{row.closure}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <ContentSection title="Closure vs. Frontal">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <h3 className="text-xl font-light text-foreground">Lace Closures</h3>
              <div className="space-y-4">
                <div className="flex justify-between py-2 border-b border-border">
                  <span className="text-muted-foreground">4×4 Closure</span>
                  <span className="text-foreground">Middle/side part</span>
                </div>
                <div className="flex justify-between py-2 border-b border-border">
                  <span className="text-muted-foreground">5×5 Closure</span>
                  <span className="text-foreground">More parting freedom</span>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-light text-foreground">Lace Frontals</h3>
              <div className="space-y-4">
                <div className="flex justify-between py-2 border-b border-border">
                  <span className="text-muted-foreground">13×4 Frontal</span>
                  <span className="text-foreground">Ear to ear coverage</span>
                </div>
                <div className="flex justify-between py-2 border-b border-border">
                  <span className="text-muted-foreground">13×6 Frontal</span>
                  <span className="text-foreground">Deep parting space</span>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
        ...
        <ContentSection title="Texture Guide">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4 bg-muted/10 p-6">
              <h3 className="text-lg font-light text-foreground">Straight</h3>
            ...
            <div className="space-y-4 bg-muted/10 p-6">
              <h3 className="text-lg font-light text-foreground">Body Wave</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="space-y-4 bg-muted/10 p-6">
              <h3 className="text-lg font-light text-foreground">Deep Wave</h3>
              <p className="text-muted-foreground text-sm">
